...
def seed():
    ...
    incidents_data = [
        ...
        (30.5510905,-96.3038147, "Wellborn Road Walkway", "Harassment reported while walking along Wellborn."),
        (30.6167609,-96.3488438, "Hullabaloo Hall", "Broken glass found at dorm entrance."),
        (30.6102546,-96.3424216, "Kyle Field", "Attempted wallet snatch after the football game."),
        (30.6243306,-96.3437045, "University Drive Tunnel", "Graffiti found inside pedestrian tunnel."),
        (30.613582,-96.3452467, "MSC Bus Stop", "Aggressive shouting at the bus stop."),
        (30.6168338,-96.3477376, "Walton Hall", "Trespasser seen entering dorm stairwell."),
        (30.6051872,-96.3473249, "Lot 100e", "Car break-in, window shattered."),
        (30.615403,-96.3439604, "Academic Plaza", "Student felt followed while walking near Academic Plaza."),
        (30.6167916,-96.3463607, "Sbisa Dining Hall", "Physical altercation reported near Sbisa."),
        (30.6060094,-96.3462325, "Reed Arena", "Unattended bag triggered safety inspection by police."),
    ]
